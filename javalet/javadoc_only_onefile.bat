...
set spath=-sourcepath d:\mine\programming\java\javalet\src\main\resources
rem "c:\Program Files\Java\jdk1.7.0_25\bin\javadoc.exe"  %encoding% %tags% TestJavaDoc.java


"c:\Program Files\Java\jdk1.7.0_25\bin\javadoc.exe"  %doclet% %spath% d:\mine\programming\java\javalet\src\main\resources\com\Test.java
